...
export default class MSNBCNewsScraper extends AbstractNewsScraper implements NewsScraperInterface {
  ...
  async scrapeRecentArticles(urls?: string[]): Promise<NewsBasicArticleType[]> {
    ...
    logger.info(`Starting to scrape the recent articles on MSNBC ...`);
      ...
      const articleUrls = this.getUniqueArray(
        await page.evaluate(() => {
          ...
          const querySelector = [
            ...
            '.layout-container .smorgasbord__column2 h2 a',
            '.layout-container .feeds .wide-tease-item__info-wrapper a',
          ].join(', ');
